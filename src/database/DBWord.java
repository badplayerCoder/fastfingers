...
public class DBWord {
	...
	private WordController wc; // Normally it is wordController, but for faster coding words in database, it
								// will be wc
	...
	/**
	 * Picks what language to use, by dropDb first then pick language db & setups
	 * new DB
	 * 
